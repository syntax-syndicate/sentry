...
def expose_fingerprint_dict(values: Fingerprint, info: FingerprintInfo):
    rv = {
        "values": values,
    }
...
class SaltedComponentVariant(ComponentVariant):
    ...
    def __init__(self, values: Fingerprint, component, config, fingerprint_info: FingerprintInfo):
