...
class DeleteIssuePlatformTest(TestCase, SnubaTestCase, OccurrenceTestMixin):
    ...
    def select_error_events(self, columns: list[str], project_id: int) -> object:
    ...
    def test_issue_platform(self) -> None:
        # events_query = partial(self.select_error_events, ["id"], self.project.id)
        ...
        # self.assert_query_n_times(events_query, [])
        ...
        # We don't yet delete the occurrence from Snuba
        self.assert_query_n_times(issue_platform_query, expected)
